...
const WeekView = () => {
    ...
    return (
      <div className="relative h-12 border-t border-gray-200">
        {slotEvents.map(event => {
          ...
          // Only render if the event starts in this specific hour slot
          if (Math.floor(startHour) === slot.hour) {
            const durationHours = endHour - startHour;
            const heightPercent = Math.max(durationHours * 100, 25); // Minimum height for very short events
            ...
            return (
              <div
                ...
                style={{
                  ...
                  backgroundColor: event.color || '#3b82f6', // Default to blue if no color
                  color: '#fff',
                  zIndex: 10
                }}
              >
  ...
  // Show all hours from 00:00 to 23:59
