...
import { User, Mail, Key, CheckSquare, ChevronRight, Edit2, Calendar, Bell, ArrowLeft } from 'lucide-react';
...
const AccountPage = () => {
  ...
  const handleTaskStatusChange = async (taskId) => {
    try {
      ...
      setTasks(tasks.map(t => 
        t.id === taskId 
          ? { ...t, status: newStatus, isLoading: false } 
          : t
      ));
      ...
      showSuccessToast(newStatus === 'completed' 
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="flex justify-between items-center mb-8 p-4 bg-white rounded-lg shadow-sm">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-medium text-slate-700">Account Details</h1>
          </div>
          <div className="flex items-center">
            <div className="w-8 h-8 rounded-full overflow-hidden bg-indigo-600 flex items-center justify-center text-white">
          ...
          <div className="md:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
              ...
              <div className="border-t pt-4">
                <h3 className="text-md font-medium text-slate-700 mb-3">Quick Links</h3>
                <div className="space-y-2">
                  ...
                  <Link to="/calander_page" className="flex items-center p-2 hover:bg-slate-50 rounded cursor-pointer transition-colors duration-150">
          ...
          <div className="md:col-span-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6 hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-medium text-slate-800">Account Details</h2>
                <button 
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6 hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-medium text-slate-800">Upcoming Events</h2>
                <Link to="/calander_page" className="text-indigo-600 flex items-center hover:text-indigo-800 transition-colors">
              ...
              <div className="space-y-3">
                {events.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <Link to="/calander_page" className="mt-2 inline-block text-indigo-600 hover:text-indigo-800 transition-colors">
                      Go to Calendar
                    </Link>
                  </div>
                ) : (
                  events.map(event => (
                    <div key={event.id} className="p-3 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors duration-150">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-medium text-slate-800">Your Tasks</h2>
                <button 
                  onClick={() => setCurrentView('allTasks')}
                  className="text-indigo-600 flex items-center hover:text-indigo-800 transition-colors"
                >
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-slate-500">Due: {task.deadline}</p>
                          </div>
                        </div>
                        <span className={`text-xs px-2 py-1 rounded ${
